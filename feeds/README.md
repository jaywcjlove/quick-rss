...
无需动鼠标，一切尽在指尖！使用键盘即可快速移动、点击和拖动鼠标光标。提升效率，保持专注。 📥 https://jaywcjlove.github.io/maslink/?id=6746747327 💬 https://github.com/jaywcjlove/mousio 功能特点 键盘驱动光标控制：使用快捷键即时移动和定位鼠标指针 网格导航模式：通过可调整大小的屏幕网格实现精准导航 多显示 ([#147](https://github.com/jaywcjlove/quick-rss/issues/147) - [@jaywcjlove](https://github.com/jaywcjlove))
...
迷你便捷的本地音乐播放器，轻巧实用，专为播放本地音频而设计，支持多种常见音频格式，随时随地畅听您的音乐！ 📥 下载：https://jaywcjlove.github.io/maslink/?id=6745227444 💬 反馈：https://github.com/jaywcjlove/musicer 核心功能 支持本地音频文件播放 波形进度条显示播放进度 自定义播放器主题颜色 一键切换迷你 ([#133](https://github.com/jaywcjlove/quick-rss/issues/133) - [@jaywcjlove](https://github.com/jaywcjlove))
...
PaletteGenius 是一款旨在提高设计师和开发者效率的屏幕颜色选择工具。 📥 下载：https://jaywcjlove.github.io/maslink/?id=6472593276 💬 反馈：https://github.com/jaywcjlove/palette-genius 为什么需要开发这个应用程序呢？ ✦ 我一直在使用系统内置的颜色选择器。它既紧凑又快速，但它也有明显的 ([#118](https://github.com/jaywcjlove/quick-rss/issues/118) - [@jaywcjlove](https://github.com/jaywcjlove))
...
这款工具能够清晰地突出显示光标的位置，让光标的移动和点击一目了然。它特别适用于会议、教学或视频教程制作等场合，帮助观众更轻松地跟随你的操作和思路，从而更好地吸引他们的注意力，提升信息的传递效果。 📥 下载: https://jaywcjlove.github.io/maslink/?id=6743495172 💬 反馈: https://github.com/jaywcjlove/focus- ([#105](https://github.com/jaywcjlove/quick-rss/issues/105) - [@jaywcjlove](https://github.com/jaywcjlove))
...
DayBar 是一款在菜单栏显示本地日期和提醒事件的应用。点击菜单栏中的 DayBar，即可查看日历、日历事件和提醒事项，并支持与 Apple 日历同步。它将日历和提醒功能整合到状态栏菜单，方便管理和查看，同时让提醒事项呈现为简洁美观的待办事项。 📥 下载链接： https://jaywcjlove.github.io/maslink/?id=6476924627 💬 反馈意见： https: ([#66](https://github.com/jaywcjlove/quick-rss/issues/66) - [@jaywcjlove](https://github.com/jaywcjlove))

...
此仓库记录了应用在 App Store 审核过程中被拒绝的各种原因，并提供了相应的解决方案。 它作为开发者的资源，帮助他们更好地了解常见的拒绝情景及如何有效应对这些问题，从而优化未来提交的审核流程。 App%20Rejection%20Fixes ([#12](https://github.com/jaywcjlove/quick-rss/issues/12) - [@jaywcjlove](https://github.com/jaywcjlove))

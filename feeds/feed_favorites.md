<p align="right">
  <a href="./feed_favorites.zh.md">中文</a>
</p>
...
<!--RSS_FAVORITES_LIST_START-->
### [Apple Coding Academy](https://applecodingacademy.com)

```
https://applecodingacademy.com/feed/
```

### [iGeeksBlog](https://www.igeeksblog.com)

Your go-to source for Apple, tech, and gaming.

```
https://www.igeeksblog.com/feed/
```

### [Livsy Code](https://livsycode.com)

Learn Swift the smart way

```
https://livsycode.com/feed/
```
...
### [BLOCKGENI](https://blockgeni.com)

Blockchain, Artificial Intelligence, Machine Learning  and Data Engineering

```
https://blockgeni.com/feed/
```

### [ZFB](https://blog.whuzfb.cn/)

这是我的个人博客

```
https://blog.whuzfb.cn/feed.xml
```

### [Swift.org](https://swift.org/atom.xml)
...
Latest SwiftUI elements added to the library

```
https://exploreswiftui.com/feed
```

### [Kristaps Grinbergs](https://kristaps.me)
...
### [Swift with Majid](https://swiftwithmajid.com/feed.xml)
...
### [ChromeOS](https://www.reddit.com/r/chromeos/.rss)
...
### [submitted by wcjiang](https://www.reddit.com/user/wcjiang/submitted.rss)

Hi, I am a software developer.

```
https://www.reddit.com/user/wcjiang/submitted.rss
```

### [r/MacApps](https://www.reddit.com/r/macapps.rss)
...
```
https://www.reddit.com/r/macapps.rss
```

### [MacOSApps](https://www.reddit.com/r/MacOSApps.rss)

Community focused on sharing FREE (or very cheap) MacOS Apps that increase our productivity.

```
https://www.reddit.com/r/MacOSApps.rss
```
...
### [Quick RSS 技术资源分享](https://wangchujiang.com/quick-rss/)

记录并分享最新的技术软件资源，持续更新，随时获取最新动态。

```
https://wangchujiang.com/quick-rss/feed.xml
```

### [肘子的 Swift 记事本 ｜ Fatbobman's Blog](https://fatbobman.com/)

中文首页｜肘子的 Swift 记事本｜Fatbobman's Blog，分享与 Swift、SwiftUI、Core Data、Swift Data 有关的内容，也会涉及开发工具、AI 等其他内容。全部文章均为原创，转载需联系本人

```
https://fatbobman.com/zh/rss.xml
```
...
### [Sarunw](https://sarunw.com/feed.xml)

I share my working processes, tip and tricks, tools, and problems I found along the way.
...
Get latest SwiftUI recipes news!

```
https://swiftuirecipes.com/blog.rss
```
...
### [blach.io](https://blach.io/atom.xml)

Things I've stumbled across while developing apps for iPad, iPhone and Mac.

```
https://blach.io/atom.xml
```

### [Zed Industries - Blog](https://zed.dev/blog)
...
Welcome to iOS Coffee Break, a place for iOS devs to share their articles, tips and apps.

```
https://www.ioscoffeebreak.com/rss.xml
```

### [CodeWithChris](https://codewithchris.com)

```
https://codewithchris.com/feed/
```

### [阿杰鲁的自留地](https://ajie.lu/)

但行好事，莫问前程

```
https://www.ajie.lu/rss/feed.xml
```
...
### [Captain SwiftUI](https://captainswiftui.substack.com)

The Captain’s Blog on Swift, SwiftUI, and Apple Development

```
https://captainswiftui.substack.com/feed.xml
```

### [Peter Friese](https://peterfriese.dev/)

Firebase, Swift, SwiftUI, and Combine articles and tips by Peter Friese

```
https://peterfriese.dev/rss.xml
```

### [Yet Another Swift Blog](https://www.vadimbulavin.com/feed.xml)
...
### [MacMost](https://macmost.com)

Mac Video Tutorials and Tips for Apple Users

```
https://macmost.com/feed
```

### [Mac-Forums | Fix Mac iPhone iPad | Buying Tips | iOS OS Help](https://www.mac-forums.com/)
...
```
https://www.mac-forums.com/forums/-/index.rss
```
...
```
https://serialcoder.dev/feed/
```

### [softwareanders.com](https://softwareanders.com/)

Blog about software development - with focus on Swift and SwiftUI

```
https://softwareanders.com/feed/
```
...
```
https://swiftbysundell.com/podcast/rss
```
...
### [HelloGitHub 月刊](https://hellogithub.com)
...
### [Create with Swift](https://www.createwithswift.com/)

Create with Swift

```
https://www.createwithswift.com/rss/
```
...
### [Pavel Zak’s dev blog](https://nerdyak.tech/atom.xml)
...
### [macOS](https://www.v2ex.com/)

way to explore

```
https://www.v2ex.com/feed/macos.xml
```

### [Jesse Squires](https://www.jessesquires.com/feed.xml)
...
### [Sketch Blog](https://www.sketch.com/blog/feed.xml)
...
AppCoda is one of the leading iOS programming communities. Our goal is to empower everyone to create apps through easy-to-understand tutorials. Learn by doing is the heart of our learning materials.
...
### [ALL About RSS - Telegram Channel](https://t.me/s/aboutrss)

关于 #RSS 技术的 #应用 #周边 #介绍 #方法 #教程 #指南 #讨论 #观点 #技巧RSS = Really Simple Syndication / Rich Site Summary推特：https://twitter.com/aboutrss频道 RSS Feed：https://feeds.feedburner.com/ALLAboutRSS频道 bot：@channelmcbot群组：@allaboutrss (福利：推特账号的 Retweet 会自动发至群组) - Powered by RSSHub

```
https://feeds.feedburner.com/AllAboutRSS
```

### [zStack](https://blog.noicdi.com/atom.xml)

```
https://blog.noicdi.com/atom.xml
```
...
### [Roy的个人站](https://geofftools.cn/blog/atom.xml)

记录一些我碰到的有意思的东西。

```
https://geofftools.cn/blog/atom.xml
```
...
### [Software Development Notes](https://swdevnotes.com/)

Recent content on Software Development Notes

```
https://swdevnotes.com/index.xml
```
...
### [云谦的博客](http://sorrycc.com)

Exploring writing, reading, technology, and AI.

```
https://sorrycc.com/feed
```

### [iOS development by tanaschita.com](https://tanaschita.com)

Learn how to develop iOS and Swift applications for Apple's platforms with quick guides tutorials, from beginner to advanced.

```
https://tanaschita.com/rss.xml
```
...
```
https://stepinto.vision/feed
```

### [CodeSpeedy](https://www.codespeedy.com/)

Coding solutions - PHP, Java, JS, Python

```
https://www.codespeedy.com/feed/
```

### [Stories by Jakir Hossain on Medium](https://medium.com/@jakir?source=rss-3ef993a5539a------2)

Stories by Jakir Hossain on Medium

```
https://medium.com/feed/@jakir
```

### [Xojo Programming Blog](https://blog.xojo.com)

Blog about the Xojo programming language and IDE

```
https://blog.xojo.com/feed/
```

### [Osas Blogs](https://swiftlogic.io/feed.xml)
